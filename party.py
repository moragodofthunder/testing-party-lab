...
def most_and_least_common_type(treats):
   ...
   ('dessert', 'drink')
   >>> treats = [{'type': 'dessert'}, {'type': 'dessert'},{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}]
   >>> most_and_least_common_type(treats)
   ('dessert', 'drink')
   >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}]
   >>> most_and_least_common_type(treats)
   ('appetizer', 'drink')
   >>> treats = [{'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}, {'type': 'drink'}]
   >>> most_and_least_common_type(treats)
   ('appetizer', 'dessert')
